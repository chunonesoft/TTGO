...
public class MyOrder extends FragmentActivity implements OnClickListener {
	private TextView bt_cart_all, bt_cart_dfk, bt_cart_dfh, bt_cart_dsh,
			bt_cart_ysh;
	private View show_cart_all, show_cart_dfk, show_cart_dfh, show_cart_dsh,
			show_cart_ysh;
	MyOrder_All all;
	MyOrder_dfk dfk;
	MyOrder_dfh dfh;
	...
	public void onClick(View v) {
		...
		case R.id.bt_cart_all:
			...
			bt_cart_all.setTextColor(getResources()
					.getColor(R.color.text_click));
			bt_cart_dfh.setTextColor(getResources().getColor(
					R.color.text_normal));
			bt_cart_dfk.setTextColor(getResources().getColor(
					R.color.text_normal));
			bt_cart_dsh.setTextColor(getResources().getColor(
					R.color.text_normal));
			bt_cart_ysh.setTextColor(getResources().getColor(
					R.color.text_normal));

			show_cart_all.setBackgroundColor(getResources().getColor(
					R.color.text_click));
			show_cart_dfk.setBackgroundColor(getResources().getColor(
					R.color.line_normal));
			show_cart_dfh.setBackgroundColor(getResources().getColor(
					R.color.line_normal));
			show_cart_ysh.setBackgroundColor(getResources().getColor(
					R.color.line_normal));
			show_cart_dsh.setBackgroundColor(getResources().getColor(
					R.color.line_normal));
			break;
		case R.id.bt_cart_dfk:
			...
			bt_cart_all.setTextColor(getResources().getColor(
					R.color.text_normal));
			bt_cart_dfh.setTextColor(getResources().getColor(
					R.color.text_normal));
			bt_cart_dfk.setTextColor(getResources()
					.getColor(R.color.text_click));
			bt_cart_dsh.setTextColor(getResources().getColor(
					R.color.text_normal));
			bt_cart_ysh.setTextColor(getResources().getColor(
		...
		case R.id.bt_cart_dfh:
			...
			bt_cart_all.setTextColor(getResources().getColor(
					R.color.text_normal));
			bt_cart_dfh.setTextColor(getResources()
					.getColor(R.color.text_click));
			bt_cart_dfk.setTextColor(getResources().getColor(
					R.color.text_normal));
			bt_cart_dsh.setTextColor(getResources().getColor(
		...
		case R.id.bt_cart_dsh:
			...
			bt_cart_dfk.setTextColor(getResources().getColor(
					R.color.text_normal));
			bt_cart_dsh.setTextColor(getResources()
					.getColor(R.color.text_click));
			bt_cart_ysh.setTextColor(getResources().getColor(
					R.color.text_normal));
		...
		case R.id.bt_cart_ysh:
			...
			bt_cart_dsh.setTextColor(getResources().getColor(
					R.color.text_normal));
			bt_cart_ysh.setTextColor(getResources()
					.getColor(R.color.text_click));
